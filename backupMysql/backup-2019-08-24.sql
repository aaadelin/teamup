...
INSERT INTO `comment` VALUES (1,'Didnt work out as intended, I broke more stuff than I fixed. Apparently it is not easy because of the side menu, there still has to be a way. Maybe remove the side menu. Or add another way to do it. To center the columns in the screen remaining','Didnt work',3,NULL,28,NULL,NULL),(2,'Bootstrap won\'t always work. If jquery is commented out -> saved -> uncommented it will work, but not for long. Looltips still work, but they\'re not as appealing.','Bootstrap problems',3,NULL,33,'2019-07-26 13:21:07',NULL),(3,'I don\'t think it is worth it for the log in. Maybe for the tasks, but they fetch pretty fast...','Is it worth it?',3,NULL,50,'2019-08-12 20:50:56',NULL),(4,'The back-end has been secured with a SSL certificare and now runs on port 8443. HTTPS','SSL Encrypt',3,NULL,57,'2019-08-15 16:24:51',NULL),(5,'No need to do this anymore. \nShow page loading is because of app.js which is 11 MB(!!!) and its size will shrink if the project will be buid.','No needed',3,NULL,23,'2019-08-20 19:59:47',NULL),(6,'Only one version will be created. Which one?','One version',3,NULL,39,'2019-08-20 20:35:22',NULL),(7,'Search in tasks is done. Next is for teams and projects.','The search feature for task is done',3,NULL,55,'2019-08-20 20:36:53',NULL),(8,'Leave it for later but create it on task loading and refreshing because it doesn\'t look very pleasant when something changes. ','Create it',3,NULL,50,'2019-08-21 15:46:00',NULL),(9,'Fix the timeline spacing.\nFetch the tasks for the piechart','Tomorrow',3,NULL,41,'2019-08-21 22:09:58',NULL),(10,'Event triggers are added for when user \n-creates a task \n-creates a comment\n-creates a user\n-updates a task\n-updates a user\n-updates a comment\n-deletes a user','Event triggers added',3,NULL,69,'2019-08-24 20:03:33',NULL);
...
INSERT INTO `user` VALUES (1,'Alex','dd24cbcba8c6ffce23089d09680be532',_binary '','2019-08-20 20:17:26','Relu','534b44a19bf18d20b71ecc4eb77c572f',NULL,2,'ralex',1,NULL,60,'2019-07-01'),(2,'Sys','F61599449EF3BA054C5AE43675D46A92',_binary '\0','2019-08-20 21:05:23','Admin','5f4dcc3b5aa765d61d8327deb882cf99',NULL,5,'admin',NULL,NULL,60,'2019-07-01'),(3,'Adelin','912FC8B10632573D0F7AD378D0A91889',_binary '','2019-08-24 22:25:01','Mirea','3A1C94D56271C14E07F477FA49C740E3','912FC8B10632573D0F7AD378D0A91889',2,'amirea',1,NULL,60,'2019-07-01'),(4,'Test','5EC79E7A94C3E998D3C3BE6EF46713D7',_binary '','2019-08-22 12:45:00','User','E10ADC3949BA59ABBE56E057F20F883E',NULL,0,'tuser',2,NULL,10000,'2019-07-01');
...
INSERT INTO `user_event` VALUES (1,'Created',0,'2019-07-01 00:00:00',27),(2,'Created first task',0,'2019-07-02 00:00:00',27),(174,'Updated task Regesign REST API endpoints',1,'2019-08-24 13:30:40',27),(175,'Updated task Sorting tasks page',1,'2019-08-24 13:30:54',27),(176,'Updated task Sorting tasks page',1,'2019-08-24 13:31:00',27),(177,'Created task Upload photo',0,'2019-08-24 16:22:30',27),(180,'Updated task Upload photo',1,'2019-08-24 16:32:31',27),(181,'Updated task Upload photo',1,'2019-08-24 19:37:30',27),(182,'Created task Update password',0,'2019-08-24 19:38:43',27),(185,'Added comment \"Event trig\" at task Add history elements to user activity',0,'2019-08-24 20:03:33',27),(187,'Created task Update text formatting in comments',0,'2019-08-24 20:07:12',27),(190,'Updated task Add history elements to user activity',1,'2019-08-24 20:17:36',27);
...
-- Dump completed on 2019-08-25  8:26:27
